...
Map<String, dynamic> _$DeviceMetadataToJson(DeviceMetadata instance) =>
    <String, dynamic>{'model': instance.model, 'osVersion': instance.osVersion};

DeviceInfo _$DeviceInfoFromJson(Map<String, dynamic> json) => DeviceInfo(
  deviceId: json['deviceId'] as String,
  timezone: json['timezone'] as String,
  timezoneOffsetMinutes: (json['timezoneOffsetMinutes'] as num).toInt(),
  lastActiveAt: const SmartTimestampConverter().fromJson(json['lastActiveAt']),
  fcmToken: json['fcmToken'] as String?,
  fcmTokenUpdatedAt: const SmartTimestampConverter().fromJson(
  ...
  platform: DevicePlatformSerialization.deserialize(
...
Map<String, dynamic> _$DeviceInfoToJson(
  ...
  'lastActiveAt': const SmartTimestampConverter().toJson(instance.lastActiveAt),
  'fcmToken': instance.fcmToken,
  'fcmTokenUpdatedAt': const SmartTimestampConverter().toJson(
  ...
  'formFactor': DeviceFormFactorSerialization.serialize(instance.formFactor),
